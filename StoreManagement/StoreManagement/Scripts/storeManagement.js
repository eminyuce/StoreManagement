...
function GetRelatedContents(categoryId, contentType) {
    ...
    ajaxMethodCall(postData, "/AjaxContents/GetRelatedContents", DisplayRelatedContents);
...
function GetRelatedProducts(productCategoryId) {
    ...
    ajaxMethodCall(postData, "/AjaxProducts/GetRelatedProducts", DisplayRelatedProducts);
...
function GetProductCategories() {
    ...
    ajaxMethodCall(postData, "/AjaxProducts/GetProductCategories", DisplayProductCategories);
