...
namespace StoreManagement.API.Controllers
{
    ...
    public class ProductsController : BaseApiController<Product>, IProductService
    {
        ...
        public async Task<List<Product>> GetProductsByProductType(int storeId, int? categoryId, int? brandId, string productType, int page, int pageSize, bool? isActive, string functionType, int? excludedProductId)
        {
            return await ProductRepository.GetProductsByProductType(storeId, categoryId, brandId, productType, page, pageSize, isActive, functionType, excludedProductId);
        }
